...
<body>
    ...
    <div style="font-family: DejaVu Sans, sans-serif; width:600px; border:4px solid #1e3a8a; margin:40px auto; padding:40px; text-align:center; background:#f3f4f6;">

        <h1 style=" font-size:30px; color:#064e3b;">
